...
// Rellenar el campo de la lista
   ...
   public void mensaje(String mensaje, String status){
    ...
    private void jButtonModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonModificarActionPerformed
    	try {
    		if (jTextFieldIDCliente.getText().isEmpty() || jTextFieldNombre.getText().isEmpty() || jTextFieldCiudad.getText().isEmpty()|| jTextFieldDNI.getText().isEmpty() || 
        		...
        		String ciudadAux = jTextFieldCiudad.getText();
        		String dirAux = jTextFieldDireccion.getText();
        		//boolean activoAux = jCheckBoxActivo.isSelected();
        		
        		TCliente tCli = new TCliente(id, nombreAux, dniAux, dirAux, ciudadAux, true);
