...
public class DepartamentoGUI extends javax.swing.JFrame {
	    ...
	    public void setDepartamentos(ArrayList<TDepartamento> lista){
	    	String temp;
	    	for(TDepartamento dep : lista){
	    		temp = dep.toString();
	    		jTextArea.append(temp + "\n");
	    	}
	    }
	    public void setSueldoDepartamento(double sueldoTotal) {
	    	jTextArea.append(sueldoTotal + " €" + "\n");
	    }	
	    
	    //Mostrar un departamento
	    public void setDepartamento(TDepartamento departamento){
	    	limpiarComponentes();
	    	jTextFieldID.setText(Integer.toString(departamento.getIdDepartamento()));
	    	jTextFieldCategoria.setText(departamento.getCategoria());
		...
		protected void jButtonSueldoActionPerformed(ActionEvent evt) {
			...
			if(jTextFieldID.getText().isEmpty()){
				...
				try{
					...
					int idDepartamento = Integer.parseInt(jTextFieldID.getText());					
					//Consultamos con el id de departamento
					Controlador.getInstance().run(ListaComandos.SUELDODEPARTAMENTO, idDepartamento);
		...
		protected void jButtonModificarActionPerformed(ActionEvent evt) {
			if(jTextFieldID.getText().isEmpty() || jTextFieldCategoria.getText().isEmpty() || jTextFieldNombre.getText().isEmpty()) {
				...
				try {
					...
					if (id <= 0) {
						...
						TDepartamento tDep = new TDepartamento(id, nombre, categoria, true);
