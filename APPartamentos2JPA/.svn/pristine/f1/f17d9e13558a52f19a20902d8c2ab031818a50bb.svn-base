...
public class CompraGUI02 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonModificarCompra = new java.awt.Button();
       ...
       // setPreferredSize(new java.awt.Dimension(1200, 550));
        ...
        jButtonModificarCompra.setLabel("MODIFICAR COMPRAS");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(jButtonModificarCompra, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 112, Short.MAX_VALUE)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jButtonModificarCompra, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
	...
	protected void jButtonModificarCompraActionPerformed(ActionEvent evt) {
		if (this.jTextFieldIDCompra.getText().isEmpty() || jTextFieldIDCliente.getText().isEmpty() || 
    			this.fecha.isEmpty() ){
			...
			JOptionPane.showMessageDialog(this, "No tiene viviendas para modificar la compra.", "Error", JOptionPane.ERROR_MESSAGE);
		}
		else{
			...
			Date fechaAux = (Date) DateLabelFormatter.toDate(this.fecha.getFecha());
    		...
    		TCompra tComp = new TCompra(idComp, idCli, fechaAux, true, lineaCompra);
    		
    		Controlador.getInstance().run(ListaComandos.MODIFICARCOMPRA, tComp);
			this.actualizaVista();
			limpiarComponentes();
    	}
	}
	...
	protected void jButtonMostrarCompraActionPerformed(ActionEvent evt) {
		if(this.viviendasPorComprar.size() != 0){
			...
			this.viviendasPorComprar = new ArrayList<>();
			actualizaVista();
			int temp = Integer.getInteger(jTextFieldIDCompra.getText());
			limpiarComponentes();
	...
	protected void jButtonVaciarCarritoActionPerformed(ActionEvent evt) {
		if(this.viviendasPorComprar.size() != 0){
			compra = null;
			for(TLineaCompra lc: viviendasPorComprar) {
				int pos = -1;
				for(int i = 0; i < viviendasDisponibles.size(); i++)
					if(lc.getId() == viviendasDisponibles.get(i).getId())
						pos = i;
				if(pos != -1)
					this.viviendasDisponibles.get(pos).setCantidad(viviendasDisponibles.get(pos).getCantidad() + lc.getCantidadComprada());
			}
			this.viviendasPorComprar = new ArrayList<>();
			this.jTextAreaCarrito.setText("");
		}
			...
			if (this.viviendasPorComprar.size() == 0){
				...
				try {
		    		...
		    		if(f.getYear()>today.getYear()){
			    		...
			    		int idCom;
			    		String a = jTextFieldIDCompra.getText();
			    		if(jTextFieldIDCompra.getText().isEmpty()) {
			    			idCom = -1;
			    		}
			    		else
    ...
    private java.awt.Button jButtonModificarCompra;
